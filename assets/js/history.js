(function () {
  ...
  function buildLocalAttemptRow(finalPayload) {
    ...
    return {
      ...
      student_profile_id: finalPayload?.studentProfileId || "",
      student_id_code: finalPayload?.studentIdCode || "",
      classroom_id: finalPayload?.classroomId || "",
      official_email: finalPayload?.officialEmail || "",
